...
const handleLogOut =()=>{
  ...
  return (
    <aside className="w-64 bg-gray-800 text-white h-screen fixed top-0 left-0">
      <div className="p-4 text-2xl font-bold">Creator Role</div>
      <nav>
        <ul>
          <li className="p-4 hover:bg-gray-700">
            <Link to="/creator">Past Blogs </Link>
          </li>
          <li className="p-4 hover:bg-gray-700">
            <Link to="/creator/write">Write a blog</Link>
          </li>
        </ul>
      </nav>
      <button
